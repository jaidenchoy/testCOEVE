...
fixVis <- function (.plot = NA) {
  ...
  # TODO: add a test if everything is OK
  require(shiny)
  require(shinythemes)
  # require(plotly)
        ...
        tabsetPanel(
          ...
          tabPanel("Legends",
                   ...
                   tabsetPanel(tabPanel("Color",
                                        tabsetPanel(make_legend_tab("col_title", "Title (color)", T),
                                                    make_legend_tab("col_text", "Labels (color)", F))),
                               tabPanel("Fill",
                                        tabsetPanel(make_legend_tab("fill_title", "Title (fill)", T),
                                                    make_legend_tab("fill_text", "Labels (fill)", F))),
                               tabPanel("Size",
                                        tabsetPanel(make_legend_tab("size_title", "Title (size)", T),
                                                    make_legend_tab("size_text", "Labels (size)", F))),
                               tabPanel("Shape",
                                        tabsetPanel(make_legend_tab("shape_title", "Title (shape)", T),
                                                    make_legend_tab("shape_text", "Labels (shape)", F))),
                               tabPanel("Linetype",
                                        tabsetPanel(make_legend_tab("linetype_title", "Title (linetype)", T),
