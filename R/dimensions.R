...
#'
#' @param .data A matrix or a data frame with features, distance matrix or output from \link{repOverlapAnalysis}, \link{geneUsageAnalysis} or \link{repDiversityAnalysis} functions.
#'
