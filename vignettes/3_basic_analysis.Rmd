...
# Basic analysis
For each task in this section `immunarch` includes separate functions that are generally self-explanatory and are written in camel-case. Shorter names for the functions are also available, although the authors do not recommend their usage for the sake of clarity and readability of the code. The latter are mentioned in parantheses. 
...
See the `fixVis` tutorial [here](https://immunarch.com/articles/7_fixvis.html).
